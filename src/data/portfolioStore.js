...
const DEFAULTS = {
    ...
    filmmaking: {
        ...
        projects: [
            { title: "Urban Echoes", category: "Short Film", year: "2025", description: "A visual poem exploring solitude in city life.", thumbnail: "/gallery/cinematic-landscape.jpg" },
            { title: "Golden Hour", category: "Music Video", year: "2025", description: "Cinematic music video shot during golden hour across three locations.", thumbnail: "/gallery/model-landscape-1.jpg" },
            { title: "Wanderlust", category: "Travel Film", year: "2024", description: "A travel documentary capturing the spirit of backpacking through Europe.", thumbnail: "/gallery/model-landscape-2.jpg" },
            { title: "Elegance in Motion", category: "Model Shoot", year: "2025", description: "A high-fashion editorial shoot blending movement and minimalism in urban architecture.", thumbnail: "/gallery/model-portrait-1.jpg" },
            { title: "Natural Light Portraits", category: "Model Shoot", year: "2025", description: "Golden hour portrait session capturing raw emotion and natural beauty outdoors.", thumbnail: "/gallery/creative-portrait-1.jpg" },
            { title: "Studio Sessions Vol. 1", category: "Model Shoot", year: "2026", description: "Creative studio portraits with dramatic lighting and bold color palettes.", thumbnail: "/gallery/creative-portrait-3.jpg" },
        ],
        socialInstagram: "",
        socialYouTube: "",
